...
namespace OnlineShop.Infra.Data.Migrations
{
    ...
    [Migration("20210714133935_SeedUserAndCartData")]
    partial class SeedUserAndCartData
    {
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Banned = false,
                            DateSignedIn = new DateTime(2021, 7, 14, 18, 9, 35, 214, DateTimeKind.Local).AddTicks(2804),
